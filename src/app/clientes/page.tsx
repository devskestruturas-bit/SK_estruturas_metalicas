...
export default function Clientes() {
  return (
    <section
      className="relative w-full pt-[25%] sm:pt-[8%] bg-cover bg-center pb-0 md:pb-40 "
    >
      ...
      <div className="relative w-full h-[400px] md:h-[400px] bg-[#F2F7FB] rounded-3xl overflow-visible flex items-center justify-between shadow-lg">
        ...
        <div className="relative z-10 w-full flex flex-col lg:flex-row items-center justify-center xl:justify-center px-6 md:px-16 gap-10">
          ...
          >
            ...
            <Image
              src="/logos-clientes-mob.png"
              alt="Logos dos clientes"
              width={650}
              height={400}
              className="object-contain mob"
            />
          </motion.div>
